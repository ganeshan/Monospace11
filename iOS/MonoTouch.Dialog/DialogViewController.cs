...
namespace MonoTouch.Dialog
{
	public class DialogViewController : UITableViewController
	{
		...
		public class Source : UITableViewSource {
			...
			{
				if (Root == null) return null;	// [CD] - i think the Root might get garbage collected or something????
				try {
					var section = Root.Sections [sectionIdx];
		...
		public override void LoadView ()
		{
			...
			var color = UIColor.FromPatternImage(UIImage.FromFile("Background.png"));
			if(tableView.Style == UITableViewStyle.Grouped)
			{
				this.ParentViewController.View.BackgroundColor = color;
